...
class Follower:
    ...
    def image_callback(self, msg):
        ...
        cv2.imwrite("origin{}.jps".format(self.i), image)

        image = deepcopy(image)
        hsv = cv2.cvtColor(image, cv2.COLOR_BGR2HSV)
        show(hsv, "hsv")
        cv2.imwrite("hsv{}.jps".format(self.i), image)
        ...
        show(mask, "erode")
        cv2.imwrite("mask{}.jps".format(self.i), mask)
        ...
        if len(contours):
            ...
            cv2.imwrite("point{}.jps".format(self.i), image)
